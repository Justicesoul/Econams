...
const Map: React.FC<IMap> = ({
  ...
  const startMap = (): void => {
    if (!map) {
      ...
      const homeLocation = new google.maps.LatLng(57.166013499, 20.3698147);
  ...
  const defaultMapStart = (): void => {
    const defaultAddress = new google.maps.LatLng(57.166013499, 20.3698147);
  ...
  return (
    <section className="map">
      <h2 className="map__title">Produkcijas realizācija Skandināvijā</h2>
